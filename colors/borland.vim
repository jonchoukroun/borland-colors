...
call s:linkGroup("Repeat", "CallourSubtle")
call s:linkGroup("Label", "CallourSubtle")
call s:linkGroup("Operator", "CallourSubtle")
call s:linkGroup("Keyword", "CallourSubtle")
call s:linkGroup("Exception", "CallourSubtle")

...
call s:setGroup("NotifyBody", s:none, s:darkwhite, s:none)
...
call s:setGroup("NotifyERRORBorder", s:darkred, s:darkred, s:none)
call s:setGroup("NotifyWARNBorder", s:darkred, s:darkwhite, s:none)
call s:setGroup("NotifyINFOBorder", s:darkred, s:darkwhite, s:none)
call s:setGroup("NotifyDEBUGBorder", s:darkred, s:darkwhite, s:none)
call s:setGroup("NotifyTRACEBorder", s:darkred, s:darkwhite, s:none)
call s:setGroup("NotifyERRORIcon", s:darkred, s:none, s:none)
call s:setGroup("NotifyWARNIcon", s:darkred, s:darkwhite, s:none)
call s:setGroup("NotifyINFOIcon", s:darkred, s:darkwhite, s:none)
call s:setGroup("NotifyDEBUGIcon", s:darkred, s:darkwhite, s:none)
call s:setGroup("NotifyTRACEIcon", s:darkred, s:darkwhite, s:none)
call s:setGroup("NotifyERRORTitle", s:darkred, s:none, s:none)
call s:setGroup("NotifyWARNTitle", s:darkred, s:darkwhite, s:none)
call s:setGroup("NotifyINFOTitle", s:darkred, s:darkwhite, s:none)
call s:setGroup("NotifyDEBUGTitle", s:darkred, s:darkwhite, s:none)
call s:setGroup("NotifyTRACETitle", s:darkred, s:darkwhite, s:none)

" Below are failed attempts, saving
" call s:setGroup("NotifyERRORBody", s:darkred, s:none, s:none)
